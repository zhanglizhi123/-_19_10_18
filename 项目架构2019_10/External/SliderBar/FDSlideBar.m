...
- (void)setupItems {
    CGFloat itemX_Yuan = 10;
    CGFloat itemX = itemX_Yuan;
    ...
    _sliderView.frame = CGRectMake((_itemsWidth-itemW)/2+(itemX_Yuan/2.0)+2, self.frame.size.height - SLIDER_VIEW_HEIGHT, itemW, SLIDER_VIEW_HEIGHT);
}
