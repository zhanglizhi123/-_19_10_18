...
- (NSString *)pickerView:(UIPickerView *)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component {
    ...
    switch (component) {
        case 0:
            return [NSString stringWithFormat:@"%@年",self.dataArray[component][row]];
            break;
        case 1:
            return [NSString stringWithFormat:@"%@月",self.dataArray[component][row]];
            break;
        case 2:
            return [NSString stringWithFormat:@"%@日",self.dataArray[component][row]];
            break;
        default:
        {
